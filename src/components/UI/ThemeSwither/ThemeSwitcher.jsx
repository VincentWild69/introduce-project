...
const ThemeSwitcher = () => {
  ...
  let themeEl = useRef(null)

  const onThemeChange = (e) => {
    themeEl.current.checked ? theme.change(THEME_DARK) : theme.change(THEME_LIGHT);
  }
  ...
  return (
    <div className={s.themeSwitcherContainer}>
      <label className={s.themeSwitcher}>
        <input ref={themeEl} onChange={onThemeChange} type='checkbox' className={s.themeCheckbox}/>
